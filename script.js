...
const translations = {
  es: {
    ...
    'example-label-1': 'Dashboards interconectados y gráficos dinámicos',
    'example-label-2': 'Generación de facturas y documentos',
    'example-label-3': 'Sincronización y alertas inteligentes',
    'example-desc-1': 'Transforma tus hojas de cálculo en cuadros de mando interactivos. Visualiza KPIs en tiempo real, gráficos automatizados y tablas dinámicas conectadas directamente a tus datos sin salir de Google Sheets.',
  ...
  en: {
    ...
    'example-label-1': 'Interconnected Dashboards & Dynamic Charts',
    'example-label-2': 'Invoice and document generation',
    'example-label-3': 'Smart synchronization and alerts',
    'example-desc-1': 'Transform your spreadsheets into interactive control panels. Visualize real-time KPIs, automated charts, and pivot tables connected live to your data directly inside Google Sheets.',
